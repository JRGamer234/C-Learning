...
// Variables globales
User* userList = NULL;              // Lista de usuarios
User* usuarioActual = NULL;        // Usuario que está logueado ahora
Circuito* listaCircuitos = NULL;   // Lista de circuitos
ResultadoCarrera* listaResultados = NULL; // Lista de resultados

// Función para cambiar el tamaño del texto que se dibuja
